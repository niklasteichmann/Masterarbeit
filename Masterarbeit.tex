...
\begin{figure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/SinglePoint_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/SinglePoint_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/SinglePoint_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/SinglePoint_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/SinglePoint_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/SinglePoint_Object3.png}
		\subcaption{}
		\label{SinglePointObject3}
	\end{subfigure}
	\caption{Der Single Point Load Datensatz mit ausgew\"ahlten Invariantenbereichen. In (a) und (b) werden nur Bereiche mit hoher Spur dargestellt, in (c) und (d) nur Bereiche mit hoher Deviatornorm, (e) und (f) nur Bereiche mit hohem Modus.}
...
Als zweites Beispiel wurde das Ergebnis einer thermo-mechanischen Simulation verwendet, die auch in der Arbeit von Friztsch benutzt wurde \cite[S.15, 45 ff.]{fritzsch2016contiuousScatterplot}. Fritzsch beschreibt den Datensatz wie folgt:

``Die Metallscheibe liegt flach auf und ist entlang ihres \"au{\ss}eren Rands fixiert. Zwecks Umformung wirkt von oben ein hoher Druck ein. Zus\"atzlich wird sie von unten erw\"armt und von oben gek\"uhlt.''
...
Da die Metallscheibe spiegelsymmetrisch zur X- und Y-Achse ist, gen\"ugt es, ein Viertel der Scheibe zu simulieren. Als Ergebnisse der Simulation wurden zwei Datens\"atze erzeugt, von denen der erste die mechanische Spannung und der zweite die Verformung an den Punkten der Metallscheibe enth\"alt. F\"ur beide Datens\"atze wurden getrennt voneinander Visualisierungen erzeugt, die im Folgenden vorgestellt werden. F\"ur beide wurde der K-Invariantensatz verwendet.
...
Abb. \ref{MetalDiskStressEllipsoids} zeigt die Spannungstensoren der Metallscheibe in Form von Ellipsoiden. Es muss beachtet werden, dass zwar ein Ellipsoid pro Datenpunkt gezeichnet wurde, diese sich aber \"uberschneiden und deshalb schwer zu unterscheiden sind. Erkennbar ist jedoch, dass die Ellipsoide am Rand der Scheibe eher kugelf\"ormig sind, wogegen die am inneren Rand eher die Form von Scheiben annehmen. Das bedeutet, dass die Betr\"age der drei Eigenwerte der Tensoren am \"ausseren Rand \"ahnliche Werte annehmen, wogegen am inneren Rand der Betrag eines einzelnen Eigenwerts deutlich kleiner als der Betrag der anderen beiden ist. Zwischen diesen beiden Bereichen existiert noch ein weiteres Gebiet, in dem die Ellipsoide eine eher l\"angliche Form annehmen. Dieses Verhalten l\"asst den Schluss zu, dass die Anisotropie am \"ausseren Rand sehr gering ist ist, zur Mitte hin stark zunimmt und dann am inneren Rand wieder leicht absinkt. Gleichzeitig nimmt die Gr\"o{\ss}e der Ellipsoiden im Bild von unten links nach oben rechts zu, dort wirken also st\"arkere Spannungen als im unteren Bereich.

Die Darstellungen der Invariantenbereiche (Abb. \ref{MetalDiskStressInteraction}) stimmen mit dieser Interpretation \"uberein. In Abb. \ref{MetalDiskStressObject1} ist zu sehen, dass die Spannung im oberen rechten Teil des Scheibenausschnitts am gr\"o{\ss}ten ist. Abb. \ref{MetalDiskStressObject2} zeigt, dass die Norm des Deviators am inneren und \"au{\ss}eren Rand der Scheibe kleiner ist als im Bereich dazwischen. Auch der Modus verh\"alt sich so wie vermutet, er ist am inneren Rand der Scheibe am gr\"o{\ss}ten (Abb. \ref{MetalDiskStressInvariant2}).
...
Die Verformungstensoren der Metallscheibensimulation sind in Abb. \ref{MetalDiskStrainEllipsoids} dargestellt. Erkennbar ist, dass die Ellipsoide am inneren Rand erheblich gr\"o{\ss}er sind als alle anderen. Die Eigenwerte dieser Tensoren haben tats\"achlich einen relativ hohen Betrag, sind jedoch teilweise negativ. Da die Spur eines Tensors der Summe seiner Eigenwerte entspricht, ist die Spur in diesem Bereich sehr niedrig. Dies f\"allt auch in Abb. \ref{MetalDiskStrainInvariant1} auf, wo Bereiche niedriger Spur ausgeblendet werden.


\begin{figure}[H]
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStress_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStress_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStress_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStress_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStress_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStress_Object3.png}
		\subcaption{}
...
\begin{figure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStrain_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStrain_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStrain_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStrain_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStrain_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/MetalDiskStrain_Object3.png}
		\subcaption{}
...
\begin{figure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_K_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_K_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_K_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_K_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_K_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_K_Object3.png}
		\subcaption{}
...
\begin{figure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_R_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_R_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_R_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_R_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_R_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Bremshebel_R_Object3.png}
		\subcaption{}
...
\begin{figure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=6cm]{pictures/results/Plate3D_Ellipsoids.png}
		\subcaption{}
	\end{subfigure}	
	\hspace*{\fill}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=6cm]{pictures/results/Plate3D_Object.png}
		\subcaption{}
	\end{subfigure}
	\hspace*{\fill}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=6cm]{pictures/results/Plate3D_InvariantSpace.png}
		\subcaption{}
	\end{subfigure}
...
\begin{figure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Plate3D_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Plate3D_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Plate3D_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Plate3D_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Plate3D_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Plate3D_Object3.png}
		\subcaption{}
...
\begin{figure}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=6cm]{pictures/results/Softnotch_Ellipsoids.png}
		\subcaption{}
	\end{subfigure}
	\hspace*{\fill}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=6cm]{pictures/results/Softnotch_Object.png}
		\subcaption{}
	\end{subfigure}
	\hspace*{\fill}
	\begin{subfigure}{0.3\textwidth}
		\centering
		\includegraphics[height=6cm]{pictures/results/Softnotch_InvariantSpace.png}
		\subcaption{}
	\end{subfigure}
	\caption{Darstellung des Single Point Load Datensatzes. (a) An jedem Punkt des Gitters wird ein Ellipsoid gezeichnet. Die L\"angen der Halbachsen entsprechen den Eigenwerten. (b) Die Darstellung des Datensatzes im Invariantenraum in gr\"un mit Interaktionsfl\"achen links und rechts davon. (c) Das DVR des Objekts.}
	\label{Softnotch}
...
\begin{figure}
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Softnotch_InvariantSpace1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Softnotch_Object1.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Softnotch_InvariantSpace2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Softnotch_Object2.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Softnotch_InvariantSpace3.png}
		\subcaption{}
	...
	\begin{subfigure}{0.49\textwidth}
		\centering
		\includegraphics[height=5cm]{pictures/results/Softnotch_Object3.png}
		\subcaption{}
